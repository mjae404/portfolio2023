const MpWorkItemData = [
    ...
    },
    {
        ...
        contents: {
            percentage: "100%",
            description: "개인 포트폴리오 사이트 2023 리액트 버전입니다.",
            images: [
                {
    ...
    {
        workName: "마크업 가이드 (개인 프로젝트)",
        workClass: "markup_guide",
        workDate: "2023.04",
        url: "http://mjae.me",
        target: "_blank",
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/markup_guide.webp",
                    jpg: "../../assets/images/markup_guide.jpg",
                    alt: "마크업 가이드 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/humuson.webp",
                    jpg: "../../assets/images/humuson.jpg",
                    alt: "휴머스온 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/targetmarketing.webp",
                    jpg: "../../assets/images/targetmarketing.jpg",
                    alt: "타겟 마케팅 솔루션 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/kyobo_bootcamp02.webp",
                    jpg: "../../assets/images/kyobo_bootcamp02.jpg",
                    alt: "교보문고 신입사원 부트캠프 과제 메인 화면"
                },
                {
                    webp: "../../assets/images/kyobo_bootcamp03.webp",
                    jpg: "../../assets/images/kyobo_bootcamp03.jpg",
                    alt: "교보문고 신입사원 부트캠프 과제 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            percentage: "100%",
            description: "개인 포트폴리오 사이트 2022 버전입니다.",
            images: [
                {
                    webp: "../../assets/images/portfolio2022.webp",
                    jpg: "../../assets/images/portfolio2022.jpg",
                    alt: "포트폴리오 사이트 2022 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            percentage: "100%",
            description: "개인 연습용 인터랙션 페이지 작업.",
            images: [
                {
                    webp: "../../assets/images/interaction_booklist.webp",
                    jpg: "../../assets/images/interaction_booklist.jpg",
                    alt: "개인 연습용 인터랙션 페이지 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            percentage: "100%",
            description: "개인 연습용 랜딩 페이지 작업.",
            images: [
                {
                    webp: "../../assets/images/interaction_coffee.webp",
                    jpg: "../../assets/images/interaction_coffee.jpg",
                    alt: "개인 연습용 인터랙션 페이지 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/portfolio2021.webp",
                    jpg: "../../assets/images/portfolio2021.jpg",
                    alt: "포트폴리오 사이트 2021 메인 화면"
                }
            ]
        }
    },
    {
        workName: "킥매치 (개인 프로젝트)",
        workClass: "kickmatch",
        workDate: "2021.12",
        contents: {
            percentage: "100%",
            description: "진행중인 모바일 전용 개인 사이드 프로젝트입니다.",
            tableCells: [
                {
                    name: "메인 페이지",
    ...
    {
        workName: "캔디버드",
        workClass: "candybirds",
        workDate: "2020.12",
        contents: {
            percentage: "100%",
            description: "모바일용 라이브스트리밍 / 몰인몰 / 중고거래쇼핑몰 / 커뮤니티 플랫폼. 앱으로도 출시 되었으며 현재는 사이트가 리뉴얼 되었습니다.",
            images: [
                {
                    webp: "../../assets/images/candybirds.webp",
                    jpg: "../../assets/images/candybirds.jpg",
                    alt: "캔디버드 메인 화면"
                }
            ]
        }
    },
    {
        ...
        workClass: "coffit",
        workDate: "2020.11",
        url: "https://coffit.co.kr",
        target: "_blank",
        contents: {
            percentage: "100%",
            description: "청주에서 움직이는 카페 할인 정기권 사이트 앱입니다. 앱으로도 출시되었으며 수정된 부분 일부 존재합니다.",
            images: [
                {
                    webp: "../../assets/images/coffit01.webp",
                    jpg: "../../assets/images/coffit01.jpg",
                    alt: "coffit 메인 화면"
                },
                {
                    webp: "../../assets/images/coffit02.webp",
                    jpg: "../../assets/images/coffit02.jpg",
                    alt: "coffit 메인 화면"
                }
            ]
        }
    },
    {
        workName: "XE3 게시판",
        workClass: "xe_board",
        workDate: "2020.03 / 2020.09 (리뉴얼)",
        url: "https://github.com/xpressengine/plugin-board/tree/develop",
        target: "_blank",
        contents: {
            percentage: "100%",
            ...
            images: [
                {
                    webp: "../../assets/images/xe01.webp",
                    jpg: "../../assets/images/xe01.jpg",
                    alt: "xe3 게시판 일반형 스킨"
                },
                {
                    webp: "../../assets/images/xe02.webp",
                    jpg: "../../assets/images/xe02.jpg",
                    alt: "xe3 게시판 블로그형 스킨"
                },
                {
                    webp: "../../assets/images/xe03.webp",
                    jpg: "../../assets/images/xe03.jpg",
                    alt: "xe3 게시판 웹진형 스킨"
                }
            ]
        }
    },
    {
        ...
        contents: {
            percentage: "100%",
            description: "오즈 아레나는 PC방 최초의 멤버십 서비스입니다. 앱으로도 출시되어 있으며 현재 사이트가 리뉴얼되어 이미지로만 확인하실 수 있습니다.",
            images: [
                {
                    webp: "../../assets/images/ozarena01.webp",
                    jpg: "../../assets/images/ozarena01.jpg",
                    alt: "OZARENA 메인 화면"
                },
                {
                    webp: "../../assets/images/ozarena02.webp",
                    jpg: "../../assets/images/ozarena02.jpg",
                    alt: "OZARENA 메인 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/tonyryu01.webp",
                    jpg: "../../assets/images/tonyryu01.jpg",
                    alt: "건승정한 메인 화면"
                },
                {
                    webp: "../../assets/images/tonyryu02.webp",
                    jpg: "../../assets/images/tonyryu02.jpg",
                    alt: "건승정한 메인 화면"
                }
            ]
        }
    },
    {
        ...
        workClass: "linedance",
        workDate: "2020.06",
        url: "http://www.linedance.or.kr/",
        target: "_blank",
        contents: {
            percentage: "85%",
            description: "대한라인댄스협회는 라인댄스의 이론과 실기의 전문 라인댄스 지도자를 양성하고 라인댄스의 국민생활화에 기여하는 협회입니다. 기존에 있는 XE3 템플릿을 사용하되, 기본적인 설정만 남기고 퍼블리싱하였습니다.",
            images: [
                {
                    webp: "../../assets/images/linedance01.webp",
                    jpg: "../../assets/images/linedance01.jpg",
                    alt: "대한라인댄스협회 메인 화면"
                },
                {
                    webp: "../../assets/images/linedance02.webp",
                    jpg: "../../assets/images/linedance02.jpg",
                    alt: "대한라인댄스협회 서브 화면"
                },
                {
                    webp: "../../assets/images/linedance03.webp",
                    jpg: "../../assets/images/linedance03.jpg",
                    alt: "대한라인댄스협회 서브 화면"
                }
            ]
        }
    },
    {
        ...
        contents: {
            ...
            images: [
                {
                    webp: "../../assets/images/uniuni.webp",
                    jpg: "../../assets/images/uniuni.jpg",
                    alt: "UNIUNI 메인 화면"
                }
            ]
        }
